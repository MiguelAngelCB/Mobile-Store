...
public class IndexController {
  ...
  public String index() throws ClassNotFoundException, SQLException {
    ...
    if (RequestContextHolder.currentRequestAttributes().getAttribute("activePage",
      ...
      RequestContextHolder.currentRequestAttributes().setAttribute("limiteErrores", limiteErrores,
          RequestAttributes.SCOPE_SESSION);
      RequestContextHolder.currentRequestAttributes().setAttribute("contadorErrores", contadorErrores,
          RequestAttributes.SCOPE_SESSION);
